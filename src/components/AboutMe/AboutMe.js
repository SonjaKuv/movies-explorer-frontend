      ...
      <section className='section about-me'>
        ...
        <div className='about-me__container'>
          <div className='about-me__info'>
            ...
            <h3 className='about-me__subtitle'>Веб-разработчик, 24 года</h3>
            ...
            После того, как прошла курс по веб-разработке, устроилась разработчиком в компанию «Лакки Проект».
           </p>
            <a className='about-me__link link' href='https://github.com/SonjaKuv' target="_blank" rel="noreferrer">Github</a>
          </div>
